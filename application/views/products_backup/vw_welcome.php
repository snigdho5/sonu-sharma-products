        ...
        <div class="container">
            <table id="myTable">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Price Updated Till October 2020</h3>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading text-muted">DP - Rs <?php echo $value['price']; ?></div>
                          ...
                          var html = '';
                            if(d.pro_data !=''){
                                $.each(d.pro_data, function (key,value) {
                                    ...
                                    html +=  '<a class="portfolio-link" target="_blank" href="'+value['image_url']+'">';
                                    ...
                                    html +=  '<div class="portfolio-caption">';
                                    html +=  '<div class="portfolio-caption-heading">No results found</div>';
